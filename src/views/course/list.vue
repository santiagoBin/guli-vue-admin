  ...
  <el-table
      ...
      <template slot-scope="scope">
        <div class="info">
          ...
          <div class="title" >
            ...
            <p style="flex-direction: row;display: flex;justify-content: start;height: 40px;"><a href="" style="height: 40px">{{ scope.row.title }}</a></p>

            <p style="flex-direction: row;display: flex;justify-content: start;height: 20px">课时：{{ scope.row.lessonNum }} </p>
          </div>
        </div>
      </template>
    </el-table-column>
    ...
    <el-table-column label="操作" width="150" align="center">
      <template slot-scope="scope">
          ...
          <el-button type="text" size="mini" icon="el-icon-edit" @click="editCourseInfo(scope.row.id)">编辑课程信息</el-button>
